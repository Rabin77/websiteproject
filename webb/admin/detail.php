...
<td><a class ="btn btn-default btn-lg"  href="delete.php?id=<?php echo $row ['id']; ?>" > Delete</a> <a class="btn btn-default btn-lg" href="accept.php?id=<?php echo $row ['id']; ?>" >Accept</a> </td>
</tr>
<?php endwhile; ?>
</table>